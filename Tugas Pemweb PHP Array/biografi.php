<?php @include "header.php"; ?>
		...
		<?php
$biodata = array (
  array("JL. Balai Desa No. 3c RT 13 RW 04, Buduran, Sidoarjo, Jawa Timur"),
  array("29 mei 2002"),
  array("Sidoarjo"),
  array("21 Tahun"),
  array("Laki-Laki")
...
<div id="page_desktop___1_ek1"  >
	...
	<div id="group_5"  >
		<div id="laki_laki" >
		<?php echo "Gender : ".$biodata[4][0]; ?>
		</div>
		<div id="_29_mei_2002" >
		<?php echo "Tanggal Lahir : ".$biodata[1][0]; ?>
		</div>
		<div id="sidoarjo" >
		<?php echo "Tempat Lahir : ".$biodata[2][0]; ?>
		</div>
		<div id="jl__balai_desa_no__3c_rt_13_rw_04__buduran__sidoarjo__jawa_timur" >
		  <?php echo "Alamat : ".$biodata[0][0]; ?>
		</div>
		<div id="informasi_dasar" >
			Informasi Dasar 
		</div>
		<div id="_21_tahun" >
		<?php echo "Umur : ".$biodata[3][0]; ?>
		</div>
