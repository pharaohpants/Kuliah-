...
<body>
    <center><h1>Total Gaji Driver</h1>
...
if (isset($_POST["check"])){
    ...
    $tarifkm = $_POST['tarif'];
    $bulan = $_POST['bulan'];
    $totalgaji = $jarak*$tarifkm;
    echo "<h2><br>SELAMAT!! Total gaji Driver pada bulan $bulan adalah Sebesar Rp.".number_format($totalgaji,0,",",".<h2>");
}
?></center>
</body>
</html>